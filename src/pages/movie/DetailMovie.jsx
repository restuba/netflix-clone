...
import { IoIosPlay as PlayBtn } from 'react-icons/io';
...
class DetailMovie extends Component {
  ...
  componentDidMount(){
    this.props.getDetails('movie',this.props.match.params.id);
    this.props.getVideo('movie', this.props.match.params.id);
  }
...
export default GlobalConsumer(DetailMovie);
