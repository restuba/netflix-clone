...
class AiringToday extends Component {
  ...
  componentDidMount(){
    ...
    this.props.getGenreList(API.getGenreListTv);
  }
  ...
  goDetail = (id) => this.props.history.push('/tv/'+id);
        ...
        <section>
          <div className="movies">
            <aside className="movies-sidemenu">
              <h2 className="title-sidemenu">TV Shows Airing Today</h2>
            ...
            <div className="movies-content">
              <h2 className="title-content">Result TV</h2>
...
export default GlobalConsumer(AiringToday);
